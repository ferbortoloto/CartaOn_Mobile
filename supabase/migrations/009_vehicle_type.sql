-- ============================================================
-- Adiciona campo vehicle_type na tabela profiles.
-- Valores possíveis: 'manual' | 'automatic' | 'electric'
--
-- Execute no SQL Editor do Supabase Dashboard.
-- ============================================================

-- 1. Adiciona a coluna no profiles
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS vehicle_type text DEFAULT 'manual';
...
BEGIN
  ...
  INSERT INTO public.profiles (
    ...
    car_model, car_options, vehicle_type,
    price_per_hour, bio,
  ...
  VALUES (
    ...
    p_car_model, p_car_options, p_vehicle_type,
...
-- 3. Garante que anon e authenticated podem chamar a função atualizada
