-- ============================================================
-- Adiciona has_car para alunos informarem se possuem veículo.
-- car_model e car_year já existem — apenas has_car é novo.
--
...
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS has_car boolean DEFAULT NULL;

-- 2. Remove versão anterior da RPC
